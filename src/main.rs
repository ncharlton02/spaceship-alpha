...
impl<'a> app::Application for AppState<'a> {
    ...
    fn click_event(&mut self, _: event::MouseButton, _: event::ElementState, pt: Point2<f32>) {
        println!("Clicked ({}, {})", pt.x, pt.y);
        ...
        raycast_system.raycast(vec![Collider::ASTEROID], near, far);
    }
